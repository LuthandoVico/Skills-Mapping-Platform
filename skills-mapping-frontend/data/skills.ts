  ...
  relatedSkills: [
    {
      ...
      description: "Managing personnel transitions and organizational transformations during strategy implementation.",
    },
    {
      ...
      description: "Communicating with and managing expectations of internal and external partners.",
    },
    {
      id: "financial-acumen",
      name: "Financial Acumen",
      similarity: "85%",
      relationType: "Core Skill",
      description: "Budgeting, allocation, and tracking of financial resources for strategic initiatives.",
    },
    {
      id: "risk-assessment",
      ...
      similarity: "81%",
      relationType: "Supporting",
      description: "Identifying operational and strategic threats to project delivery and developing contingency plans.",
    },
  ],
  occupations: [
    {
